  ...
  return (
    <div>
      {selectedCategoryData && (
        <div key={selectedCategoryData._id} className="px-6 lg:px-0 ml-28">
      ...
      <div className="flex items-center ">
        ...
        <div className="py-3">Sản Phẩm Trong Danh Mục</div>
      </div>
      ...
      <div>
        <div className="new_title lt clear_pd " style={{ width: "1255px" }}><h4><a href="">{selectedCategoryData.category_name}</a></h4></div>
