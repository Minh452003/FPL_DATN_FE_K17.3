    ...
    <div className="container_swap">
      <div className="container">
        <div className="flex items-center ml-16">
          ...
          <div className="pl-2 font-bold">Giường ngủ hiện đại</div>
          <FaArrowRight className="ml-2" />
          <div className="pl-2 font-bold">Giường gỗ sồi tự nhiên</div>
        </div>
        <div className="content">
          <div className="flex">
            <h3 className="font-bold pt-10 pl-52 iklm">Giường gỗ sồi tự nhiên</h3>
            <p className="price">11.111.111đ</p>
          </div>
          <div className="grid grid-cols-2 gap-2 np">
            ...
            <div className="product-text">
              ...
              <div className="col-span-2 flex">
                ...
                <div className="text2 pl-1">LyPoKi</div>
              </div>
              <div className="col-span-2 flex">
                <div className="text1">Loại:</div>
                <div className="text2 pl-20 kj">LyPoKi</div>
              </div>
              <div className="color">
                <p>Màu sắc</p>
              </div>
              ...
              <div className="information">
                <p>
                  Phòng ngủ có vai trò quan trọng đối với mỗi cá nhân để định
                  hình cá tính và quan điểm sống của chủ nhân khi nghỉ ngơi mỗi
                  ngày để lấy lại năng lượng mỗi ngày hứng khởi vừa có không
                  gian nghiên cứu và sáng tạo cho học tập...
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="include">
          ...
          <label htmlFor="chi-tiet" className="detail tab-link current" data-tab="tab-1">Thông tin chi tiết</label>
          
          <input type="radio" id="binh-luan" name="tab" />
          <label htmlFor="binh-luan" className="comment tab-link" data-tab="tab-2">Bình luận</label>
            ...
            <div className="containers">
              <div className="product-sokss">
                ...
                >
                  ...
                  <SwiperSlide style={{width: "285px",marginLeft: "27px"}}>
                      <div
                        className="items slick-slides slick-currents slick-actives"
                        tabIndex={-1}
                        role="option"
                        aria-describedby="slick-slide10s"
                        style={{ width: "235px",marginLeft: "-18px",marginRight: "37px" }}
                        data-slick-index="0"
                        aria-hidden="false"
                      >
                      ...
                      <div
                        ...
                        style={{ width: "268px",marginLeft: "-65px",marginRight: "18px" }}
                        data-slick-index="1"
                        aria-hidden="false"
                      >
                      ...
                      <div
                        ...
                        role="option"
                        aria-describedby="slick-slide12s"
                        style={{ width: "273px",marginLeft: "-64px",marginRight: "42px" }}
                        data-slick-index="2"
                        aria-hidden="false"
                      >
                      ...
                      <div
                        ...
                        role="option"
                        aria-describedby="slick-slide13s"
                        style={{ width: "267px",marginLeft: "-56px",marginRight: "57px" }}
                        data-slick-index="3"
                        aria-hidden="false"
                      >
                      ...
                      <div
                        ...
                        role="option"
                        aria-describedby="slick-slide10s"
                        style={{ width: "264px",marginLeft: "-57px"/* ,marginRight: "37px" */ }}
                        data-slick-index="0"
                        aria-hidden="false"
                      >
