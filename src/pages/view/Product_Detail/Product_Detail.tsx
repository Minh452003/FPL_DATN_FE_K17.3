                                        ...
                                        filteredColors.map((color: any) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    aria-label="M"
                                                    aria-disabled="false"
                                                    className={` border boder-1 text-sm font-bold rounded-lg py-1 px-2 ${
                                                        isActive ? 'active1' : ''
                                                    }`}
                                        ...
                                        filteredSizes.map((size: any) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    aria-label="M"
                                                    aria-disabled="false"
                                                    className={`text-sm border boder-1 rounded-lg px-2 py-1 ${
                                                        isActive ? 'active1' : ''
                                                    }`}
                        ...
                        <div className="flex justify-center ">
                            <div className="flex space-x-4  ">
                                <div>
                                    ...
                                    <label
                                        htmlFor="chi-tiet"
                                        className={` md:text-xl font-bold tab-link ${
                                            ...
                                            <div className="rating-buttons space-x-2  md:mt-0 mt-3">
                                                {['Tất cả', 1, 2, 3, 4, 5].map((rating) => (
                                                    <button
                                                        ...
                                                        className={`rating-button py-1 px-2 ${
