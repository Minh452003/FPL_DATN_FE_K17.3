        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-4 col-md-4 col-sm-4 col-xs-6">
              <a href="phong-khach" className="tl" title="Phòng Khách">
                <p className="ttt">
                  Phòng Khách
                ...
                <picture>
                  <img
                    alt="Phòng Khách"
                    src="//bizweb.dktcdn.net/thumb/large/100/368/970/themes/740033/assets/bn_cate_1.jpg?1693834920118"
                  />
                </picture>
              </a>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-4 col-xs-6">
              <a href="phong-ngu" className="tl" title="Phòng Ngủ">
                <p className="ttt">
                  Phòng Ngủ
                  <span>Xem sản phẩm</span>
                </p>
                <picture>
                  <img
                    alt="Phòng Ngủ"
                    src="//bizweb.dktcdn.net/thumb/large/100/368/970/themes/740033/assets/bn_cate_2.jpg?1693834920118"
                  />
                </picture>
              </a>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <a href="phong-bep" className="tl" title="Phòng Bếp">
                <p className="ttt">
                  Phòng Bếp
                  <span>Xem sản phẩm</span>
                </p>
                <picture>
                  <img
                    alt="Phòng Bếp"
                    src="//bizweb.dktcdn.net/thumb/large/100/368/970/themes/740033/assets/bn_cate_3.jpg?1693834920118"
                  />
                </picture>
              </a>
            </div>
